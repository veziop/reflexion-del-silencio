...
from database import connexion_db, crear_tablas
...
def obtener_recomendacion_diaria() -> Response:
    ...
    (capitulo_recomendado,) = random.choices(df_capitulo.id.to_list(), weights=ponderacion, k=1)
    ...
    comando = "INSERT INTO lectura(fecha, dia_del_año, año, capitulo_id) VALUES (?, ?, ?, ?)"
